		...
		<Layout>
			<div className="container">
				<div className="">
					...
					<table className="table-auto border-collapse border border-slate-100 w-1/2 hover:border-collapse">
						<thead>
									...
									<tr key={client.id}>
										...
										<td className="border border-slate-900 text-center">
											<Link href={"/Clients/" + client.id}>
												<FontAwesomeIcon
													icon={faEye}
													className="text-slate-800 hover:text-cyan-800"
												/>
											</Link>
										</td>
									</tr>
